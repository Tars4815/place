...
// Load database credentials from config.phps
$config = include '../assets/php/config.php';
...
<body>
	...
	<!--<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				<a class="navbar-brand" href="#">3D Viewer</a>
			</div>
		...
		<div class="potree_container">
			...
			<div id="customAnnotationForm" class="custom-form">
				...
				<div class="position-input-container">
					...
					<input type="text" id="strel" name="strel">
			...
			<div id="structural-element-panel" class="custom-form">
				...
				<label for="el_position">Scalar field:</label>
				<div class="position-input-container">
					<input type="text" id="elpos" name="elpos">
					<button id="pickElButton">Pick element</button>
				</div>
	...
	<!-- Layers filter list -->
	<img id="layers_icon" src="./assets/icons/layers.svg" style="filter: invert(0);" title="Layers" />
	...
	<!-- Elements list -->
	<img id="elements_icon" src="./assets/icons/structural-element.svg" title="Structural elements" />
	<div id="elements_panel" style="display: none;">
		<ul id="elements_list">
